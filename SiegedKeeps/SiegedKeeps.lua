...
local REFRESH_INTERVAL_MS = 5000  -- TODO: Maybe move to settings menu
local PIN_SIZE = 70  -- TODO: Maybe move to settings menu
local PIN_SIZE_RESOURCE = 40  -- TODO: Maybe move to settings menu
local PIN_LEVEL = 10  -- TODO: Maybe move to settings menu
...
function GetBattlegroundContext()
...
local function OnPlayerActivated(event)
	...
	-- LMP:AddPinFilter(PIN_TYPE_SIEGE, GetString(SIEGEDKEEPS_FILTER), true, QuestMap.settings.pinFilters)
